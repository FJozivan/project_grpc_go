...
type CategoryCreateResquest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CategoryCreateResquest) Reset() {
	*x = CategoryCreateResquest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CategoryCreateResquest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CategoryCreateResquest) ProtoMessage() {}

func (x *CategoryCreateResquest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_course_category_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CategoryCreateResquest.ProtoReflect.Descriptor instead.
func (*CategoryCreateResquest) Descriptor() ([]byte, []int) {
	return file_proto_course_category_proto_rawDescGZIP(), []int{2}
}

func (x *CategoryCreateResquest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CategoryCreateResquest) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
var file_proto_course_category_proto_rawDesc = []byte{
	...
	0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x3a, 0x0a, 0x0a,
	0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x12, 0x2c, 0x0a, 0x0a, 0x63, 0x61,
	...
	0x67, 0x6f, 0x72, 0x79, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3c, 0x0a, 0x0e, 0x43,
	...
	0x65, 0x52, 0x65, 0x73, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0c, 0x2e, 0x70, 0x62, 0x2e, 0x43,
	0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x22, 0x00, 0x12, 0x2d, 0x0a, 0x0e, 0x4c, 0x69, 0x73,
	0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x12, 0x09, 0x2e, 0x70, 0x62,
	0x2e, 0x42, 0x6c, 0x61, 0x6e, 0x6b, 0x1a, 0x0e, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x61, 0x74, 0x65,
	0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x22, 0x00, 0x42, 0x0d, 0x5a, 0x0b, 0x69, 0x6e, 0x74, 0x65,
...
var file_proto_course_category_proto_goTypes = []interface{}{
	...
	(*CategoryCreateResquest)(nil), // 2: pb.CategoryCreateResquest
	(*Categories)(nil),             // 3: pb.Categories
}
var file_proto_course_category_proto_depIdxs = []int32{
	1, // 0: pb.Categories.categories:type_name -> pb.Category
	2, // 1: pb.CategoryService.CreateCategory:input_type -> pb.CategoryCreateResquest
	0, // 2: pb.CategoryService.ListCategories:input_type -> pb.Blank
	1, // 3: pb.CategoryService.CreateCategory:output_type -> pb.Category
	3, // 4: pb.CategoryService.ListCategories:output_type -> pb.Categories
...
func file_proto_course_category_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_course_category_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CategoryCreateResquest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
